...
type Apartment struct {
	...
	BuildingID null.Int    `boil:"building_id" json:"building_id,omitempty" toml:"building_id" yaml:"building_id,omitempty"`
...
var (
	...
	apartmentColumnsWithoutDefault = []string{}
	apartmentColumnsWithDefault    = []string{"id", "building_id", "number", "floor", "sq_meters"}
...
func (o *Apartment) RemoveBuilding(ctx context.Context, exec boil.ContextExecutor, related *Building) error {
	var err error
	...
	for i, ri := range related.R.Apartments {
		if queries.Equal(o.BuildingID, ri.BuildingID) {
			continue
		}

		ln := len(related.R.Apartments)
		if ln > 1 && i < ln-1 {
			related.R.Apartments[i] = related.R.Apartments[ln-1]
		}
		related.R.Apartments = related.R.Apartments[:ln-1]
		break
	}
	return nil
}
